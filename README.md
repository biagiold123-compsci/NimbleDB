...
WHERE Clause Evaluation	Boolean expressions, AND/OR/NOT, LIKE pattern matching, IN, IS NULL, comparison operators
...
.save <path>	Save the database to a JSON file
.load <path>	Load a database from a JSON file
